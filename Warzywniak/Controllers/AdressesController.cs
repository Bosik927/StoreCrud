...
namespace Warzywniak.Controllers
{
    public class AdressesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AdressId,RoadName,HouseNumber,UserId,RowVersion")] Adress adress)
        {
            ...
            ViewBag.UserId = new SelectList(db.Users, "UserId", "Nick", adress.UserId);
            return View(adress);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AdressId,RoadName,HouseNumber,UserId,RowVersion")] Adress adress)
        {
            if (ModelState.IsValid)
            {
